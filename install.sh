...
FILES="eve_dashboard.py ore_types.json ore_refine.json eve_map.json npc_factions.json site_sigs.json mining_tools.json mission_sigs.json mission_items.json mission_fingerprints.json market_types.json gank_groups.json skill_plan.json README_INSTALL.md start_dashboard.sh"
